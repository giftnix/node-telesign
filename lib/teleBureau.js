...
(function() {
  ...
  TeleBureau.submitEvent = function(options, callback) {
    ...
    options.occurredAt = options.occurredAt.toISOString();
    if (options.discoveredAt) options.discoveredAt = options.discoveredAt.toISOString();
    if (options.verifiedAt) options.verifiedAt = options.verifiedAt.toISOString();
