...
(function() {
  ...
  TeleBureau.submitEvent = function(options, callback) {
    ...
    if (options.discoveredAt) options.discoveredAt = moment(options.discoveredAt).format(dateFormat);
    if (options.verifiedAt) options.verifiedAt = moment(options.verifiedAt).format(dateFormat);
