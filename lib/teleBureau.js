...
(function() {
  ...
  TeleBureau.submitEvent = function(options, callback) {
    ...
    options.occurredAt = moment.utc(options.occurredAt).toISOString();
    if (options.discoveredAt) options.discoveredAt = moment.utc(options.discoveredAt).toISOString();
    if (options.verifiedAt) options.verifiedAt = moment.utc(options.verifiedAt).toISOString();
