...
(function() {
  ...
  Verify.twoWaySms = function(options, callback) {
    if (!options || typeof options !== 'object') {
      ...
      throw new Error('Error calling Verify 2-Way SMS - "phoneNumber" not provided in the request params.');
    } else if (!options.ucid) {
      throw new Error('Error calling Verify 2-Way SMS - "ucid" not provided in the request params.');
    } else if (!options.message) {
      throw new Error('Error calling Verify 2-Way SMS - "message" not provided in the request params.');
    } else if (!options.validityPeriod) {
      throw new Error('Error calling Verify 2-Way SMS - "validityPeriod" not provided in the request params.');
    } else if (!callback || typeof callback !== 'function') {
  ...
  Verify.push = function(options, callback) {
    if (!options || typeof options !== 'object') {
      ...
      throw new Error('Error calling Verify Push - "phoneNumber" not provided in the request params.');
    } else if (!options.template) {
      throw new Error('Error calling Verify Push - "template" not provided in the request params.');
    } else if (!callback || typeof callback !== 'function') {
  ...
  Verify.softToken = function(options, callback) {
    if (!options || typeof options !== 'object') {
      ...
      throw new Error('Error calling Verify Soft Token - "phoneNumber" not provided in the request params.');
    } else if (!options.verifyCode) {
      throw new Error('Error calling Verify Soft Token - "verifyCode" not provided in the request params.');
    } else if (!callback || typeof callback !== 'function') {
  ...
  Verify.verifyRegistration = function(options, callback) {
    if (!options || typeof options !== 'object') {
      ...
      throw new Error('Error calling Verify Registration - "phoneNumber" not provided in the request params.');
    } else if (!callback || typeof callback !== 'function') {
